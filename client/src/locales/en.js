export default {
  ...
  restocking: {
    title: "Restocking",
    description:
      "Set a budget and get recommended items to restock based on demand forecasts",
    budgetLabel: "Available Budget",
    budgetHelp:
      "Adjust the slider to see restocking recommendations that fit your budget",
    ...
    orderError: "Failed to place order: {error}",
  },
