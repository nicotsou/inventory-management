  ...
  <div class="orders">
    ...
    <div v-else>
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">
            {{ t("orders.submittedOrders") }} ({{ purchaseOrders.length }})
          </h3>
        </div>
        <div v-if="purchaseOrders.length === 0" class="loading">
          ...
          <table class="orders-table">
            ...
            <tbody>
              <tr v-for="po in purchaseOrders" :key="po.id">
                ...
                <td>
                  {{
                    t("restocking.leadTimeDays", { count: po.lead_time_days })
                  }}
                </td>
                ...
                <td>
                  <strong
                    >{{ currencySymbol
                    }}{{ po.total_cost.toLocaleString() }}</strong
                  >
                </td>
              </tr>
            </tbody>
